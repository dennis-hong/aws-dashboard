...
class DeleteGroup(policy.PolicyTargetMixin, tables.DeleteAction):
    ...
    def delete(self, request, obj_id):
        ec2.delete_security_group(request, obj_id)


class ImportGroup(tables.LinkAction):
    name = "import"
    verbose_name = _("Import Security Group")
    url = "horizon:aws:access_and_security:security_groups:import"
    classes = ("ajax-modal",)
    icon = "download"
...
class EditGroup(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:aws:access_and_security:security_groups:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class ManageRules(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:aws:access_and_security:security_groups:detail"
    icon = "pencil"
...
class SecurityGroupsTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        table_actions = (ImportGroup, DeleteGroup, SecurityGroupsFilterAction)
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:aws:access_and_security:security_groups:add_rule"
    classes = ("ajax-modal",)
    icon = "plus"
...
class DeleteRule(tables.DeleteAction):
    ...
    def get_success_url(self, request):
        ...
        return reverse("horizon:aws:access_and_security:"
