...
from aws_dashboard.content.aws.access_and_security.\
    security_groups import forms as aws_forms
from aws_dashboard.content.aws.access_and_security.\
    security_groups import tables as aws_tables


class DetailView(tables.DataTableView):
    table_class = aws_tables.RulesTable
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:aws:access_and_security:index')
...
class UpdateView(forms.ModalFormView):
    form_class = aws_forms.UpdateGroup
    ...
    submit_url = "aws:access_and_security:security_groups:update"
    success_url = reverse_lazy('aws:access_and_security:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('aws:access_and_security:index')
...
class AddRuleView(forms.ModalFormView):
    ...
    submit_label = _("Add")
    submit_url = "aws:access_and_security:security_groups:add_rule"
    url = "aws:access_and_security:security_groups:detail"
    ...
    def get_form_kwargs(self):
        ...
        security_groups = []
        for group in groups:
            if group.id == self.kwargs['security_group_id']:
...
class ImportView(forms.ModalFormView):
    form_class = aws_forms.ImportGroup
    form_id = "import_security_group_form"
    modal_header = _("Import Security Group")
    modal_id = "import_security_group_modal"
    template_name = 'aws/access_and_security/security_groups/import.html'
    submit_label = _("Import Security Group")
    submit_url = reverse_lazy(
        "horizon:aws:access_and_security:security_groups:import")
    success_url = reverse_lazy('horizon:aws:access_and_security:index')
    page_title = _("Import Security Group")
