...
(function () {
   ...
   * @ngdoc controller
   *
   * @name horizon.dashboard.aws.containers.ContainersController
   *
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.aws.containers.ContainersController', ContainersController);
  ...
  ContainersController.$inject = [
    ...
    'horizon.dashboard.aws.containers.baseRoute',
