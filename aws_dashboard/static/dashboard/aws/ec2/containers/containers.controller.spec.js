...
(function() {
  ...
  describe('horizon.dashboard.aws.containers containers controller', function() {
    ...
    beforeEach(module('horizon.dashboard.aws.containers', function($provide) {
      $provide.value('horizon.dashboard.aws.containers.containers-model', fakeModel);
    }));
    ...
    function createController() {
      return controller(
        'horizon.dashboard.aws.containers.ContainersController', {
          'horizon.dashboard.aws.containers.baseRoute': 'base ham',
          'horizon.dashboard.aws.containers.containerRoute': 'eggs '
        });
    }
