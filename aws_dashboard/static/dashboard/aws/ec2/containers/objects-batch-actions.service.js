...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.aws.containers.objects-batch-actions', batchActions)
    .factory('horizon.dashboard.aws.containers.objects-batch-actions.create-folder',
             createFolderService)
    .factory('horizon.dashboard.aws.containers.objects-batch-actions.delete', deleteService)
    .factory('horizon.dashboard.aws.containers.objects-batch-actions.upload', uploadService);

  batchActions.$inject = [
    'horizon.dashboard.aws.containers.objects-batch-actions.create-folder',
    'horizon.dashboard.aws.containers.objects-batch-actions.delete',
    'horizon.dashboard.aws.containers.objects-batch-actions.upload'
  ];
  ...
  function uploadModal(html, $modal) {
    var localSpec = {
      backdrop: 'static',
      controller: 'horizon.dashboard.aws.containers.UploadObjectModalController as ctrl',
      templateUrl: html
    };
