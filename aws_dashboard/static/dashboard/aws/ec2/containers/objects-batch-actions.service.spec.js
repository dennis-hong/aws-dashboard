...
(function() {
  ...
  describe('horizon.dashboard.aws.containers objects batch actions', function test() {
    ...
    beforeEach(inject(function inject($injector, _$q_, _$rootScope_) {
      batchActions = $injector.get('horizon.dashboard.aws.containers.objects-batch-actions');
