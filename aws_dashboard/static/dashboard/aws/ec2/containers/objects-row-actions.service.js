...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.aws.containers.objects-row-actions', rowActions)
    .factory('horizon.dashboard.aws.containers.objects-actions.delete', deleteService)
    .factory('horizon.dashboard.aws.containers.objects-actions.download', downloadService)
    .factory('horizon.dashboard.aws.containers.objects-actions.edit', editService)
    .factory('horizon.dashboard.aws.containers.objects-actions.view', viewService);

  rowActions.$inject = [
    'horizon.dashboard.aws.containers.objects-actions.delete',
    'horizon.dashboard.aws.containers.objects-actions.download',
    'horizon.dashboard.aws.containers.objects-actions.edit',
    'horizon.dashboard.aws.containers.objects-actions.view',
  ...
  viewService.$inject = [
    ...
    'horizon.dashboard.aws.containers.basePath',
  ...
  function editService(swiftAPI, basePath, model, $qExtensions, modalWaitSpinnerService,
    ...
    function perform(file) {
      var localSpec = {
        backdrop: 'static',
        controller: 'horizon.dashboard.aws.containers.EditObjectModalController as ctrl',
