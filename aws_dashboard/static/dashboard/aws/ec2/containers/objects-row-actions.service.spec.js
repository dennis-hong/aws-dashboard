...
(function() {
  ...
  describe('horizon.dashboard.aws.containers objects row actions', function test() {
    ...
    beforeEach(module(function before($provide) {
      $provide.constant('horizon.dashboard.aws.containers.basePath', '/base/path/');
    ...
    beforeEach(inject(function inject($injector, _$modal_, _$rootScope_) {
      rowActions = $injector.get('horizon.dashboard.aws.containers.objects-row-actions');
      model = $injector.get('horizon.dashboard.aws.containers.containers-model');
      $modal = _$modal_;
    ...
    describe('viewService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$q_) {
        ...
        viewService = $injector.get('horizon.dashboard.aws.containers.objects-actions.view');
        $q = _$q_;
      }));
    ...
    describe('editService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$q_) {
        swiftAPI = $injector.get('horizon.app.core.openstack-service-api.swift');
        editService = $injector.get('horizon.dashboard.aws.containers.objects-actions.edit');
