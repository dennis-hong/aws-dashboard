...
(function() {
  ...
  describe('horizon.dashboard.aws.containers objects controller', function() {
    beforeEach(module('horizon.framework'));
    beforeEach(module('horizon.app.core.openstack-service-api'));
    beforeEach(module('horizon.dashboard.aws.containers'));
    beforeEach(module(function before($provide) {
      $routeParams = {};
      $provide.value('$routeParams', $routeParams);
      $provide.constant('horizon.dashboard.aws.containers.basePath', '/base/path/');
      $provide.constant('horizon.dashboard.aws.containers.containerRoute', 'eggs/');
    }));
    ...
    function createController(folder) {
      ...
      return controller(
        'horizon.dashboard.aws.containers.ObjectsController',
        {$scope: $scope}
      );
    }
