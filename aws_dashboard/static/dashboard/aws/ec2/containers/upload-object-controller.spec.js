...
(function() {
  ...
  describe('horizon.dashboard.aws.containers upload-object controller', function() {
    var controller, ctrl;
    ...
    beforeEach(module(function ($provide) {
      $provide.value('horizon.dashboard.aws.containers.containers-model', {
        container: {name: 'spam'},
        folder: 'ham'
      });
    }));
    ...
    beforeEach(inject(function ($injector) {
      ...
      ctrl = controller('horizon.dashboard.aws.containers.UploadObjectModalController');
