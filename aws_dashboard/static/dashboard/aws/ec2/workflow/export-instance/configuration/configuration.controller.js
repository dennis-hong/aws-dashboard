...
(function () {
  ...
  angular
    ...
    .controller('ExportInstanceConfigurationController', ExportInstanceConfigurationController);

  /**
   * @ngdoc controller
   * @name ExportInstanceConfigurationController
   * @description
   * The `ExportInstanceConfigurationController` controller is responsible for
   ...
   */
  function ExportInstanceConfigurationController() {
    var ctrl = this;
