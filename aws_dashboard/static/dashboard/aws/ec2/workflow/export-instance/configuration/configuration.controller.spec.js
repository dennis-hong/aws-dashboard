...
(function() {
  ...
  describe('Export Instance Configuration Step', function() {

    describe('ExportInstanceConfigurationController', function() {
      var ctrl;

      beforeEach(module('horizon.dashboard.aws.workflow.export-instance'));

      beforeEach(inject(function($controller) {
        ctrl = $controller('ExportInstanceConfigurationController');
      }));
