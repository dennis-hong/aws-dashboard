...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name ExportInstanceDetailsController
   * @description
   * The `ExportInstanceDetailsController` controller provides functions for
   * configuring the details step of the Export Instance Wizard.
   *
   */
  angular
    .module('horizon.dashboard.aws.workflow.export-instance')
    .controller('ExportInstanceDetailsController', ExportInstanceDetailsController);

  ExportInstanceDetailsController.$inject = [
    '$scope',
    'horizon.framework.widgets.charts.donutChartSettings',
    'horizon.framework.widgets.charts.quotaChartDefaults'
  ];

  function ExportInstanceDetailsController($scope,
    donutChartSettings,
    quotaChartDefaults
  ) {
