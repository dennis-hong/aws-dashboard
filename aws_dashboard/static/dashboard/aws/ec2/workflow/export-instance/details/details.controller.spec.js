...
(function() {
  ...
  describe('Export Instance Details Step', function() {
    var noop = angular.noop;

    beforeEach(module('horizon.dashboard.project'));

    describe('ExportInstanceDetailsController', function() {
      ...
      beforeEach(inject(function($controller, $rootScope, $q) {
        ...
        ctrl = $controller('ExportInstanceDetailsController', { $scope: scope });
