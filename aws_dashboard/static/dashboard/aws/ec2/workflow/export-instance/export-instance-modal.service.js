...
(function () {
  ...
  angular
    ...
    .factory(
      ...
      ExportInstanceModalService
    );

  ExportInstanceModalService.$inject = [
    '$modal',
    '$window',
    'horizon.dashboard.aws.workflow.export-instance.modal-spec'
  ];

  function ExportInstanceModalService($modal, $window, modalSpec) {
    var service = {
      open: open
    };
    ...
    function open(launchContext) {
      ...
      var exportInstanceModal = $modal.open(localSpec);
      ...
      return exportInstanceModal.result.then(
