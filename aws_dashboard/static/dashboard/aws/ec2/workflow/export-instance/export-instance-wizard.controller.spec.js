...
(function () {
  ...
  describe('ExportInstanceWizardController tests', function() {
    var ctrl;
    var model = {
    ...
    beforeEach(module(function ($provide) {
      ...
      $provide.value('exportInstanceModel', model);
      $provide.value('horizon.dashboard.aws.workflow.export-instance.workflow',
        { thing: true });
    }));
    beforeEach(inject(function ($controller) {
      spyOn(model, 'initialize');
      ctrl = $controller('ExportInstanceWizardController', {$scope: scope});
    }));
