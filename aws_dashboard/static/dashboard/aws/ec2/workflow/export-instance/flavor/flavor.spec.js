...
(function () {
  ...
  describe('Export Instance Flavor Step', function () {
    describe('ExportInstanceFlavorController', function () {
      var ctrl, scope, model, defaults;

      beforeEach(module('horizon.dashboard.aws.workflow.export-instance'));
      ...
      beforeEach(inject(function ($controller, $rootScope) {
        ...
        ctrl = $controller('ExportInstanceFlavorController as selectFlavorCtrl',
                           { $scope:scope,
                             'horizon.framework.widgets.charts.quotaChartDefaults': defaults,
                             exportInstanceModel: model });
      }));
      ...
      describe("when having allocated flavors", function () {
        beforeEach(function () {
          ...
          scope.exportInstanceFlavorForm['allocated-flavor'] = { $setValidity: function () {} };
          spyOn(scope.exportInstanceFlavorForm['allocated-flavor'], "$setValidity");
        });
        describe("and you call #validateFlavor", function () {
          it("marks the flavor as validated", function () {
            ctrl.validateFlavor();
            expect(scope.exportInstanceFlavorForm['allocated-flavor']
