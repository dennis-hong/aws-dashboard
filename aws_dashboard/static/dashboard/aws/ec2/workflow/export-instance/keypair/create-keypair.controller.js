...
(function () {
  ...
  angular
    ...
    .controller('ExportInstanceCreateKeyPairController', ExportInstanceCreateKeyPairController);

  ExportInstanceCreateKeyPairController.$inject = [
    '$modalInstance',
    'existingKeypairs',
  ...
  /**
   * @ngdoc controller
   * @name ExportInstanceCreateKeyPairController
   ...
   */
  function ExportInstanceCreateKeyPairController($modalInstance, existingKeypairs, nova,
