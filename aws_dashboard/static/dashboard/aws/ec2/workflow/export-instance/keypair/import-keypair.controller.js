...
(function () {
  ...
  angular
    ...
    .controller('ExportInstanceImportKeyPairController', ExportInstanceImportKeyPairController);

  ExportInstanceImportKeyPairController.$inject = [
    '$modalInstance',
  ...
  /**
   * @ngdoc controller
   * @name ExportInstanceImportKeyPairController
   ...
   */
  function ExportInstanceImportKeyPairController($modalInstance, novaAPI, toastService, basePath) {
    var ctrl = this;
