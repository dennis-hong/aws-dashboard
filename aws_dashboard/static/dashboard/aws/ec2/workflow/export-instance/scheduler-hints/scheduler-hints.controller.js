...
(function() {
  ...
  /**
   * @ngdoc controller
   * @name ExportInstanceSchedulerHintsController
   * @description
   * The `ExportInstanceSchedulerHintsController` controller provides functions for
   * configuring the scheduler hints step of the Export Instance Wizard.
   *
   */
  angular
    .module('horizon.dashboard.aws.workflow.export-instance')
    .controller('ExportInstanceSchedulerHintsController', ExportInstanceSchedulerHintsController);

  ExportInstanceSchedulerHintsController.$inject = [
    'horizon.framework.util.i18n.gettext'
  ];

  function ExportInstanceSchedulerHintsController(gettext) {
    var ctrl = this;
