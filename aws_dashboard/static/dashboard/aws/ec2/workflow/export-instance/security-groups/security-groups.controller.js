...
(function () {
  ...
  angular
    ...
    .controller('ExportInstanceSecurityGroupsController', ExportInstanceSecurityGroupsController);

  ExportInstanceSecurityGroupsController.$inject = [
    'exportInstanceModel',
  ...
  /**
   * @ngdoc controller
   * @name ExportInstanceSecurityGroupsController
   ...
   */
  function ExportInstanceSecurityGroupsController(exportInstanceModel, basePath) {
    var ctrl = this;

    ctrl.tableData = {
      available: exportInstanceModel.securityGroups,
      allocated: exportInstanceModel.newInstanceSpec.security_groups,
      displayedAvailable: [],
      displayedAllocated: []
    };
