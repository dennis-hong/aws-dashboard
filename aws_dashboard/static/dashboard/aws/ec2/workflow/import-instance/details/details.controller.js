...
(function () {
  ...
  /**
   * @ngdoc controller
   * @name ImportEC2InstanceDetailsController
   * @description
   * The `ImportEC2InstanceDetailsController` controller provides functions for
   * configuring the details step of the Import Instance Wizard.
   *
   */
  angular
    .module('horizon.dashboard.aws.workflow.import-instance')
    .controller('ImportEC2InstanceDetailsController', ImportEC2InstanceDetailsController);

  ImportEC2InstanceDetailsController.$inject = [
    '$scope',
    'horizon.framework.widgets.charts.donutChartSettings',
    'horizon.framework.widgets.charts.quotaChartDefaults'
  ];

  function ImportEC2InstanceDetailsController($scope,
    donutChartSettings,
    quotaChartDefaults
  ) {
