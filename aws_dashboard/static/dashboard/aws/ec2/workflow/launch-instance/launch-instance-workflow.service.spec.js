...
(function() {
  ...
  describe('horizon.dashboard.aws.workflow.launch-instance.workflow tests', function () {
    ...
    beforeEach(inject(function ($injector) {
      ...
      stepPolicy = $injector.get('horizon.dashboard.aws.workflow.launch-instance.step-policy');
    }));
